 ...
 *   https://datatables.net/download/#bs5/dt-1.10.25/e-2.0.4/b-1.7.1/sc-2.0.4/sl-1.3.3
 *
 * Included libraries:
 *   DataTables 1.10.25, Editor 2.0.4, Buttons 1.7.1, Scroller 2.0.4, Select 1.3.3
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.10.25/e-2.0.4/b-1.7.1/sc-2.0.4/sl-1.3.3",
...
$(function() {
	modal = new bootstrap.Modal(dom.content[0], {
		backdrop: "static",
		keyboard: false
	});
});
