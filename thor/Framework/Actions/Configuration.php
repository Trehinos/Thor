...
use Thor\Framework\Configurations\{RoutesConfiguration, SecurityConfiguration, DatabasesConfiguration};
...
final class Configuration extends WebController
{
    ...
    #[Route('add-firewall', '/config/security/firewall/add')]
    public function securityFirewallModal(): Response
    {
        $routes = array_keys(RouterFactory::createRoutesFromConfiguration(RoutesConfiguration::get('web')));
        sort($routes);

        return $this->twigResponse(
            'thor/configuration/firewall-modal.html.twig',
            [
                'routes' => $routes
            ]
        );
